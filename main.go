...
func main() {
	...
	flagScraperRateLimit := flag.Uint("scraperratelimit", 20, "Maximum number of requests scraper sends per 30 seconds")
	...
	viper.Set("scraperratelimit", int(*flagScraperRateLimit))
