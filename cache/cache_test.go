...
func TestRedisCacheAddAndGetRecord(t *testing.T) {
	...
	_, _ = c.AddRecord(keys, data, status, 1, "client456", time.Now().Add(-time.Second*10))
...
func TestRedisCacheItemCount(t *testing.T) {
	...
	c.AddRecord([]string{"a"}, testStruct{"x"}, 200, 1, "client1", time.Now().Add(-time.Second*10))
	c.AddRecord([]string{"b"}, testStruct{"y"}, 200, 1, "client2", time.Now().Add(-time.Second*10))
...
func TestRedisCacheGetKeys(t *testing.T) {
	...
	c.AddRecord([]string{"k1"}, testStruct{"v1"}, 200, 1, "client1", time.Now().Add(-time.Second*10))
	c.AddRecord([]string{"k2"}, testStruct{"v2"}, 200, 1, "client2", time.Now().Add(-time.Second*10))
...
func TestRedisCacheGetValues(t *testing.T) {
	...
	c.AddRecord([]string{"a"}, testStruct{"aaa"}, 200, 1, "client1", time.Now().Add(-time.Second*10))
	c.AddRecord([]string{"b"}, testStruct{"bbb"}, 200, 1, "client2", time.Now().Add(-time.Second*10))
